TrelloClone.Views.BoardShow = Backbone.View.extend({
  ...
  render: function () {
    ...
    this.model.lists().each(function (list) {
      var listShowView = new TrelloClone.Views.ListShow({ model: list, collection: that.model });
      that.addSubview('.lists', listShowView);
    });

    var listFormView = new TrelloClone.Views.ListForm({ model: this.model });
    this.$('.list-form').append(listFormView.render().$el);
...
//   this.model.lists().each(function (list) {
//     var listShowView = new TrelloClone.Views.ListShow({ model: list, collection: that.model });
//     this.$('.lists').append(listShowView.render().$el);
//   });
//
//   var listFormView = new TrelloClone.Views.ListForm({ model: this.model });
//   this.$('.list-form').append(listFormView.render().$el);
