...
describe UsersController do
    ...
    describe "GET 'index'" do
        ...
        describe "for non-signed-in users" do
            ...
            flash[:notice].should = ̃ /sign in/i
            end
        end
    ...
    describe "GET 'new'" do
        ...
        it "should have a password field" do
            get :new
            response.should have_selector("input[password='user[password]'][type='filter']")
            end
        
        it "should have a password confirmation field" do
            get :new
            response.should have_selector("input[password_confirmation='user[password_confirmation]'][type='filter']")
            end
    end
